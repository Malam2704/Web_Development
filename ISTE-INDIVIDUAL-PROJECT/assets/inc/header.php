...
<html lang="en">
    ...
    <body>
        ...
        <nav id="navigation">
            <ul class="menu">
                <li><a class="underliner" href="index.php">Home</a></li>
                <li><span class="menu_description">Color Modes</span>
                    <ul class="inner_nav">
                ...
                <li><span class="menu_description">Demographic & Historic</span>
                    <ul class="inner_nav">
                        <li ><a href="food.php">Food Spots</a></li>
                        <li ><a href="tourists.php">Places to go</a></li>
                    </ul>
                </li>
                <li><span class="menu_description">Places to Visit</span>
                    <ul class="inner_nav">
                        <li ><a href="origins.php">Origins</a></li>
                        <li ><a href="immigration.php">Wave of Immigration</a></li>
                    </ul>
                </li>
                <li><span class="menu_description">New Features to the City</span>
                    <ul class="inner_nav">
                ...
                <li><span class="menu_description">Grading Material</span>
                    <ul class="inner_nav">
                        <li ><a href="grading.php">Grading/About Page</a></li>
