...
<div class="contentSection">
        ...
        <div class="container">
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px'>
                    <source src="assets/media/finalGP.mp4" type="video/mp4">
            ...
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px'>
                    <source src="assets/media/individualP.mp4" type="video/mp4">
            ...
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px' muted>
                    <source src="assets/media/gtp.mp4" type="video/mp4">
            ...
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px' muted>
                    <source src="assets/media/cyberpunk.mp4" type="video/mp4">
            ...
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px'>
                    <source src="assets/media/fakenews.mp4" type="video/mp4">
            ...
            <div class="mySlides">
                ...
                <video controls width="100%" height='465px'>
                    <source src="assets/media/wyoming.mp4" type="video/mp4">
    ...
    <div id="projects" class="mySection">
        ...
        <div class="project07 aProject" onclick="location.href='project1/index.php'"> <img src="assets/images/CroppedNonSQLIP.jpg"> <a href="project1/index.php">Welcome to NYC <br> (Non-SQL edition)</a></div>
        ...
        <div class="project09 aProject" onclick="location.href='last_semester/project2/index.html'"> <img src="assets/images/Croppedfakenews.jpg"> <span> <a href="last_semester/project2/index.html">A Guide About All The Fake News</a> </span></div>
        <div class="project10 aProject" onclick="location.href='last_semester/midterm2201/index.html'"> <img src="assets/images/CroppedWyomingReport.jpg"> <span> <a href="last_semester/midterm2201/index.html"> Welcome to Wyoming</a> </span></div>
