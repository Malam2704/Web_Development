        ...
        <ul class="commentUL">
            <?php
                if(sizeof($records) > 10){
                    for ($x = 0; $x <= 10; $x++) {
                        $commentString .= '<li class="comLi"><span class="dateName"> Username: ' . $records[$x]['uname'] . "</span> <span class='dateMod'> Date Posted: " . $records[$x]['last_modified'] . "</span><p> Comment: " . $records[$x]['comment'] . "</p></li><br>";
                    }
                }else{
