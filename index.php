    ...
    <div class="topSection">
        ...
        <div class="contentSection">
            ...
            <div id="projects" class="mySection">
                ...
                <div class="project1 aProject" onclick="location.href='ISTE240-ISTE240-Group-Project/index.php'" > <img src="assets/images/CroppedGroupLogin.jpg"> <a href="ISTE240-Group-Project/index.php">The CSS Survival Guide</a></div>
                <div class="project2 aProject" onclick="location.href='newGame/index.html'" > <img src="assets/images/CroppedGTP.jpg"> <a href="newGame/index.html">Democrat or Republican, The Game</a></div>
                <div class="project3 aProject" onclick="location.href='ISTE-ISTE-INDIVIDUAL-PROJECT/index.php'" > <img src="assets/images/CroppedIndividualPorject.jpg"> <a href="ISTE-INDIVIDUAL-PROJECT/index.php">Welcome to New York City</a></div>
                <div class="project4 aProject" onclick="location.href='altgroup/index.php'" > <img src="assets/images/CroppedCommentSectionGroup.jpg"> <a href="altgroup/index.php">The CSS Survival Guide <br> (Non-SQL edition)</a></div>
                <div class="project5 aProject" onclick="location.href='last_semester/project3/index.html'" > <img src="assets/images/CroppedWebCalculator.jpg"> <span> <a href="calculator/index.html">Web Calculator</a> <span></div>
                <div class="project6 aProject" onclick="location.href='nycproject/index.php'" > <img src="assets/images/CroppedNonSQLIP.jpg"> <a href="project1/index.php">Welcome to NYC <br> (Non-SQL edition)</a></div>
                <div class="project7 aProject" onclick="location.href='last_semester/project3/index.html'" > <img src="assets/images/CroppedCyberPunk.jpg"> <span> <a href="last_semester/project3/index.html">CyberPunk 2077 fanpage</a> <span></div>
                <div class="project8 aProject" onclick="location.href='last_semester/project2/index.html'" > <img src="assets/images/Croppedfakenews.jpg"> <span> <a href="last_semester/project2/index.html">A Guide About All The Fake News</a> </span></div>
                <div class="project9 aProject" onclick="location.href='last_semester/midterm2201/index.html'" > <img src="assets/images/CroppedWyomingReport.jpg"> <span> <a href="last_semester/midterm2201/index.html"> Welcome to Wyoming</a> </span></div>
            </div>
